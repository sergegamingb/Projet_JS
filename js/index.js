                    ...
                    .one("click", function () {
                        $.ajax({
                            ...
                            $('#addNote').append('<div class="card">' +
                                '<div class="card-body">' +
                                '<input type="text" name="object" class="form-control input" placeholder="Objet de la note (max 40 caractères)" maxlength="40">' +
                                '<textarea type="text" name="mNote" class="form-control input" placeholder="Écrivez votre note ici (max 200 caractères)" rows="7" maxlength="200">' +
                                '</textarea>' +
